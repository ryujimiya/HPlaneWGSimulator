...
namespace KrdLab.Lisys.Method
{
    ...
    public class LUDecomposition
    {
        ...
        /// <remarks>
        /// <para>内部では，<paramref name="X"/> のコピーに対して <see cref="KrdLab.clapack.Function.dgetrf"/> を適用する．</para>
        ...
        public LUDecomposition(Matrix X)
        {
            ...
            int ret = clapack.Function.dgetrf(lu._body, lu._rsize, lu._csize, ref p);
            if (0 < ret)
            {
